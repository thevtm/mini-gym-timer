...
var $author$project$App$init = function (_v0) {
	return _Utils_Tuple2(
		{s: 40, n: 10, f: $author$project$App$Idle},
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {aA: processes, aM: taggers};
	});
...
var $author$project$App$Exercise = function (a) {
	return {$: 2, a: a};
};
var $author$project$App$Finished = {$: 3};
		...
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							f: $author$project$App$Prepare(0)
						}),
			...
			case 3:
				...
				switch (_v1.$) {
					case 1:
						var seconds = _v1.a;
						return (_Utils_cmp(seconds, model.n) > -1) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{
									f: $author$project$App$Exercise(0)
								}),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							_Utils_update(
								model,
								{
									f: $author$project$App$Prepare(seconds + 1)
								}),
							$author$project$Sounds$playCountdown(model.n - seconds));
					case 2:
						var seconds = _v1.a;
						return (_Utils_cmp(seconds, model.s) > -1) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{f: $author$project$App$Finished}),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							_Utils_update(
								model,
								{
									f: $author$project$App$Exercise(seconds + 1)
								}),
							$author$project$Sounds$playCountdown(model.s - seconds));
					default:
...
var $author$project$App$Start = {$: 0};
var $author$project$App$Stop = {$: 1};
...
var $author$project$App$isRunning = function (state) {
	switch (state.$) {
		case 1:
			return true;
		case 2:
...
var $author$project$SvgPath$getPointInCircle = F3(
	function (_v0, radius, angleRad) {
		var cx = _v0.a;
		var cy = _v0.b;
		return _Utils_Tuple2(
			cx + ($elm$core$Basics$sin(angleRad) * radius),
			cy + (($elm$core$Basics$cos(angleRad) * radius) * (-1)));
	});
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$SvgPath$svgPathArc = F2(
	function (radius, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return A2(
...
var $author$project$SvgPath$svgPathMove = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$core$String$join,
...
var $author$project$SvgPath$makeCircle = F4(
	function (_v0, radius, rotation, length) {
		var cx = _v0.a;
		var cy = _v0.b;
		if (length > 180) {
			return A2(
				...
				_List_fromArray(
					[
						A4(
						$author$project$SvgPath$makeCircle,
						_Utils_Tuple2(cx, cy),
						radius,
						rotation,
						180),
			...
			var pB = A3(
				$author$project$SvgPath$getPointInCircle,
				_Utils_Tuple2(cx, cy),
				radius,
				$elm$core$Basics$degrees(rotation + length));
			var pA = A3(
				$author$project$SvgPath$getPointInCircle,
				_Utils_Tuple2(cx, cy),
				radius,
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$SvgPath$svgPathMove(pA),
						A2($author$project$SvgPath$svgPathArc, radius, pB)
					]));
		}
	});
...
var $author$project$App$view = function (model) {
	...
	var dimensions = {ao: 100, aO: 100};
	var center = _Utils_Tuple2(dimensions.aO / 2, dimensions.ao / 2);
	var angleStep = 360 / (model.n + model.s);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$App$isRunning(model.f) ? $author$project$App$Stop : $author$project$App$Start)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$class('graphic'),
							...
							[
								...
								_List_fromArray(
									[
										...
										A4($author$project$SvgPath$makeCircle, center, 40, 0, 360))
									]),
								_List_Nil),
								A2(
								$elm$svg$Svg$path,
								_List_fromArray(
									[
										...
										$elm$svg$Svg$Attributes$strokeWidth('3'),
										$elm$svg$Svg$Attributes$d(
										A4($author$project$SvgPath$makeCircle, center, 40, 0, prepareSeconds * angleStep))
									]),
								_List_Nil),
								A2(
								$elm$svg$Svg$path,
								_List_fromArray(
									[
										...
										$elm$svg$Svg$Attributes$strokeWidth('3'),
										$elm$svg$Svg$Attributes$d(
										A4($author$project$SvgPath$makeCircle, center, 40, model.n * angleStep, exerciseSeconds * angleStep))
									]),
								_List_Nil)
							]))
					]))
...
var $author$project$App$main = $elm$browser$Browser$element(
	{a3: $author$project$App$init, bk: $author$project$App$subscriptions, bo: $author$project$App$update, bp: $author$project$App$view});
